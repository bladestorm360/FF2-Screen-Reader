@echo off
cd /d "%~dp0"
echo Building FFII Screen Reader Mod... > build_log.txt
echo Building...
...
echo Deploying...
copy /Y "bin\Debug\net6.0\FFII_ScreenReader.dll" "D:\Games\steamlibrary\steamapps\common\FINAL FANTASY II PR\Mods\" >> build_log.txt 2>&1
